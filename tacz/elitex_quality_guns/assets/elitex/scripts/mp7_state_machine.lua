...
local function runReloadAnimation(context)
    ...
    if (isNoAmmo(context)) then
        ...
        elseif (ext == 1) then
            context:runAnimation("reload_extended_empty", track, false, PLAY_ONCE_STOP, 0.2)
        ...
        elseif (ext == 1) then
            context:runAnimation("reload_extended", track, false, PLAY_ONCE_STOP, 0.2)
        elseif (ext == 2 or ext == 3) then
            context:runAnimation("reload_extended", track, false, PLAY_ONCE_STOP, 0.2)
        else
            context:runAnimation("reload_tactical", track, false, PLAY_ONCE_STOP, 0.2)
...
local function runInspectAnimation(context)
    ...
    if (isNoAmmo(context)) then
        ...
        elseif (ext == 1) then
            context:runAnimation("inspect_empty_ext", track, false, PLAY_ONCE_STOP, 0.2)
        elseif (ext == 2 or ext == 3) then
            context:runAnimation("inspect_empty_ext", track, false, PLAY_ONCE_STOP, 0.2)
        else
            context:runAnimation("inspect_empty", track, false, PLAY_ONCE_STOP, 0.2)
        ...
        elseif (ext == 1) then
            context:runAnimation("inspect_ext", track, false, PLAY_ONCE_STOP, 0.2)
        elseif (ext == 2 or ext == 3) then
            context:runAnimation("inspect_ext", track, false, PLAY_ONCE_STOP, 0.2)
        else
            context:runAnimation("inspect", track, false, PLAY_ONCE_STOP, 0.2)
